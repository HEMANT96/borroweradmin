...
import Repayment from './profile/Repayment';
import LoanTerms from './profile/LoanTerms';
import LoanSchedule from './profile/LoanSchedule';
import PendingDues from './profile/PendingDues';
import LoanFiles from './profile/LoanFiles';
import LoanComments from './profile/LoanComments';
            ...
            <div className={this.state.isActive ? "sidebar d-flex flex-column" : "sidebar d-flex flex-column open"}>
                ...
                <div className="sidebar-nav">
                     <ul>
                        ...
                        <li><Link to="/my-loan" className="active" ><i className="fa fa-folder" aria-hidden="true"></i>My Loans</Link></li>
                        ...
                        <div className="custom-accordion">
                            <Accordion defaultActiveKey="0">
                                <Card>
                                    ...
                                    <Card.Body>
                                        <div className="form-wrap form-cols"><Repayment/></div>
                                    </Card.Body>
                                    </Accordion.Collapse>
                                </Card>
                                <Card>
                                    ...
                                    <Card.Body>
                                        <div className="form-wrap form-cols"><LoanTerms/></div>
                                    </Card.Body>
                                    </Accordion.Collapse>
                                </Card>
                                <Card>
                                    ...
                                    <Card.Body>
                                        <div className="form-wrap form-cols"><LoanSchedule /></div>
                                    </Card.Body>
                                    </Accordion.Collapse>
                                </Card>
                                <Card>
                                    ...
                                    <Card.Body>
                                        <div className="form-wrap form-cols"><PendingDues/></div>
                                    </Card.Body>
                                    </Accordion.Collapse>
                                </Card>
                                <Card>
                                    ...
                                    <Card.Body>
                                        <div className="form-wrap form-cols"><LoanFiles/></div>
                                    </Card.Body>
                                    </Accordion.Collapse>
                                </Card>
                                <Card>
                                    ...
                                    <Card.Body>
                                        <div className="form-wrap form-cols"><LoanComments /></div>
                                    </Card.Body>
                                    </Accordion.Collapse>
                                </Card>
                            </Accordion>
