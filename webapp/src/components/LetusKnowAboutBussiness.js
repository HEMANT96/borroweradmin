...
import ApplyLoans from './profile/ApplyLoans'
                ...
                <div className="dashboard-row d-flex flex-wrap dashboard-row-reverse">
                    ...
                    <div className="dashboard-col">
                        <div className="d-flex flex-wrap flex-row align-items-center justify-content-center"> 
                            <div className="color m-2 text-center ">
                              <div className=" m-4 rdius">  
                            <Link to="/let-us-konw-more">
                              <img className="text-center m-2" src={home} /> 
                                <div className="text-primary pb-3"> Pocket Loan</div>
                                 </Link>
                               </div> 
                           </div>
                            <div className="color m-2 text-center">

                            <div className="m-4 rdius3">  
                               <Link to="/let-us-konw-more">
                                 <img className="text-center m-2" src={home} />  
                                <div className="text-primary pb-3">Aarambh</div>   
                               </Link>
                              </div> 
                             </div>

                            <div className="text-center color m-2">
                             <div className=" m-4 rdius2">  
                              <Link to="/let-us-konw-more">
                                <img className="m-2" src={home}/>     
                                  <div style={{ textDecoration: 'none'}} className="text-primary pb-3"> Pratham</div>
                                </Link>
                              </div> 
                             </div>
                            <div className="text-center color m-2">
                               <div className=" m-4 rdius1">  
                                 <Link to="/let-us-konw-more">
                                   <img className="m-2" src={home}/>     
                                 <div className="text-primary pb-3"> Pratham</div>
                               </Link>
                              </div> 
                            </div>
                        </div>
