                    ...
                    <div className="dashboard-col">
                        <div className="d-flex flex-row flex-wrap align-items-center justify-content-center"> 
                           {/*  <div className="color m-2 text-center ">
                            <Link to="/about-more">
                           <img className="text-center m-4" src={home} /> 
                           <div className="text-primary"> Pocket Loan</div>
                           </Link>
                           </div> */}
                            <div className="color m-2 text-center">
                            <Link to="/about-more">
                            <img className="text-center m-4" src={product} />  
                            <div className="text-primary"> Aarambh</div>   
                            </Link>
                            </div>

                            <div className="text-center color m-2">
                            <Link to="/about-more">
                            <img className="m-4" src={shiksha} />     
                            <div className="text-primary"> Pratham</div>
                            </Link>
                            </div>
                            {/* <div className="text-center color m-2">
                            <Link to="/about-more">
