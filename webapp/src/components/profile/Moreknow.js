...
//function Contact() {
class MoreKnow extends Component {   
    constructor(props) {
        super(props);
        this.state = {
         applyLoanDetails: '',
        ...
        <div>
            <Form>
                ...
                <Form.Group className="w-100" controlId="formBasicEmail">
                  <Form.Label>Select Loan Amount*</Form.Label>
                  <Form.Control
                        as="select"
                        onChange={e => {
                ...
                <Form.Group controlId="formBasicEmail">
                  ...
                  <Form.Control type="text" placeholder="Address" maxlength="20" onChange={(e) => this.handleAddressChange(e)} value={this.state.address} />
              </Form.Group>
                
                <Form.Group controlId="formBasicEmail">
                   <Form.Label>Tenure Months</Form.Label>
                  <Form.Control type="text" className="red" placeholder="1.5% per Month (Fixed)" maxlength="20" onChange={(e) => this.handleAddressChange(e)} value={this.state.address} />
              </Form.Group>
              <Form.Group controlId="formBasicEmail">
              ...
              <Form.Group controlId="formBasicEmail">
                ...
                <div className="form-submit mt-5 pb-4">
                    <Link to="/">
