  ...
  this.setState({   });
   ...
   render(){
    ...
    return (
      <div>
         <div className="mt-1">
            <div className=" mt-0 text-left pt-0">
                    <h3>Loan Files</h3>
             </div>
          </div>
              <div className="mt-2">
                  <div className="mt-0 pt-0">
                      No Loan files, Click to upload loan files
                  </div>
                 </div>  
                 <button className="w-100 bg-primary text-white border-0 p-2 rounded">UPDATE</button>     
              </div>
        );
      }
    }
