              ...
              <ToastContainer/>
               ...
               console.log("e.target.value", e.target.value);
                ...
                <Form.Group controlId="formBasicEmail">
                  ...
                  <Form.Control type="text" className="red" placeholder="1.5% per Month (Fixed)" disabled maxlength="20" onChange={(e) => this.handleAddressChange(e)} value={this.state.address} />
              </Form.Group>
              <Form.Group controlId="formBasicEmail">
