    ...
    return (
      <div>
            <div className="mt-1">
                ...
                <div className="mt-4">
                    <div className="box-content shadow d-flex justify-content-around mt-0 pt-3">
                        <div>
                           <div>Loan Status:</div>
                           <div>Loan Application Id:</div>
                           <div>Loan Product:</div>
                        </div>
                        <div>
                        <div>{this.state.loanStatus}</div>
                        <div>{this.state.appId}</div>
                        <div>{this.state.loanProduct}</div>
                    </div>
                </div>
           </div>
           <div className="mt-4">
           ...
           <div className="mt-4">
                    <div className="box-content shadow d-flex justify-content-around mt-0 pt-3">
                        <div>
                           <div>Disbursed By:</div>
                           <div>Principal Amount:</div>
                           <div>Loan Release Date:</div>
                           <div>Number Of Repayments:</div>
                        </div>
                        <div>
                        <div>{this.state.disbursedBy}</div>
                        <div>{this.state.principleAmuont}</div>
                        <div>{this.state.loanReleaseDate}</div>
                        <div>{this.state.numberOfRepayment}</div>
                    </div>
                </div>
           </div> 
           <div className="mt-4">
