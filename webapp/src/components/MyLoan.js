...
import MyLoans from './profile/MyLoans';
                        ...
                        <div className="custom-accordion">
                           {/*  <Accordion defaultActiveKey="0">
                                <Card>
                                    ...
                                    <i className="fa fa-folder" aria-hidden="true"></i>                                    <div className="title title-line">
                                    <h4>My Loan Details</h4>
                                    </div>
                                    </Accordion.Toggle>
                                    <Accordion.Collapse eventKey="0">
                                    <Card.Body>
                                        <div className="form-wrap form-cols"></div>
                                    </Card.Body>
                                    </Accordion.Collapse>
                                </Card>
                           </Accordion> */}
